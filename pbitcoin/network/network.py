...
from pbitcoin.block.block import Block
from pbitcoin.block.merkle import MerkleTree
...
class MerkleBlock:
    ...
    def parse(cls, s):
        ...
        return cls(version, prev_block, merkle_root, timestamp, bits, nonce, total_tx_in_block, hashes, flags)
